...
json_encode(Tuples, State) when is_tuple(Tuples) ->
    case is_obj(Tuples) of
        ...
        false ->
            json_encode_tuple_to_array(Tuples, State)
    end;
...
json_encode_tuple_to_array({}, _State) ->
    <<"[]">>; 
json_encode_tuple_to_array(Tuples, State) when erlang:is_tuple(Tuples) ->
    json_encode_array(erlang:tuple_to_list(Tuples), State).
